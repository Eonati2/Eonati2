...
| `price` | $149 launch, $197 standard | `research/12-decision-record-v4.md` | Decision, unresolved |
| `outbound_capacity` | 6,800 contacts / 90 days | Mailbox arithmetic in `commercial-cleaning-os/automation/stack.md` | **Structural** — effort cannot raise it |
...
- Mailbox count or sending capacity changes.
...
|---|---|
| Price $149 → $197 | **Falls by roughly half.** Largest single lever available. |
...
The ranking is the point. **Price is the strongest lever, and it is a decision, not a project.**
Capacity is the weakest, and it is the one most often proposed as the answer. Adding mailboxes is
the expensive way to move the number least.

The user has an unresolved $149 vs $197 decision. This table is the distribution-side input to it:
$197 roughly halves the amount of audience that has to be built. That has to be weighed against
whatever conversion penalty the higher price carries — which is also unmeasured. State both.

## 5. What would have to be true

For $10,000 at $149 inside 90 days, all of these at once:

1. Outbound runs at full capacity — 6,800 contacts actually reached, not planned.
2. Contact → purchase lands at the top of the assumed band, 0.5%.
3. Between 1,100 and 5,100 qualified people download the free kit.
...
At 13–57 qualified downloads a day, every day, for ninety days: no channel currently running
...
- **Averaging the band.** "About 3,000 downloads" hides that the answer is anywhere from 1,100 to
  5,100 depending on two rates nobody has measured. Report the band.
